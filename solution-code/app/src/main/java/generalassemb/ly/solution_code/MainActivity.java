...
public class MainActivity extends AppCompatActivity implements DataSingleton.DataSingletonListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JobInfo firstJob = new JobInfo.Builder(1, new ComponentName(this,
                FirstJobService.class))
                .setRequiredNetworkType(JobInfo.NETWORK_TYPE_ANY)
                .setBackoffCriteria(1000,JobInfo.BACKOFF_POLICY_LINEAR)
                .build();

        JobInfo secondJob = new JobInfo.Builder(2, new ComponentName(this,
                SecondJobService.class))
                .setRequiredNetworkType(JobInfo.NETWORK_TYPE_ANY)
                .setBackoffCriteria(1000,JobInfo.BACKOFF_POLICY_LINEAR)
                .build();

        JobInfo thirdJob = new JobInfo.Builder(3, new ComponentName(this,
                ThirdJobService.class))
                .setPeriodic(5000)
                .build();

        Log.d(TAG, "onCreate: Scheduling jobs");
